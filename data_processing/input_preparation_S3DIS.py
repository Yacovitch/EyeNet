...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, default='/nas2/jacob/S3DIS_merged/original_ply', help='original dataset path')
    parser.add_argument('--output_path', type=str, default='/nas2/jacob/S3DIS_merged', help='original dataset path')
