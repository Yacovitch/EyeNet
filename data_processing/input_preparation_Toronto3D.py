...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, default='/nas2/jacob/data/Toronto3D/original_data', help='')
    parser.add_argument('--output_path', type=str, default='/nas2/jacob/data/Toronto3D', help='original dataset path')
    parser.add_argument('--grid_size', type=float, default=0.04, help='sampling grid size default=0.2')
    ...
    for sample_type in preparation_types:
        for pc_path in files:
            ...
            xyz, rgb, labels = DP.read_ply_data_toronto_3D(pc_path, with_rgb=True)
